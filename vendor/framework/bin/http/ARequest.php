...
use framework\bin\base\ACollection;
/**
...
class ARequest
{
        ...
        if (empty($config)) {
            $config = array(
                ...
                'base' => str_replace(array(
                    ...
                    ' '), array(
                    '/',
                    '%20'), dirname($this->getVar('SCRIPT_NAME'))),
                ...
                'query' => new ACollection($_GET),
                'data' => new ACollection($_POST),
                'cookies' => new ACollection($_COOKIE),
                'files' => new ACollection($_FILES),
                               ...
                               $secure = FALSE)
    {
        ...
        if ($secure == FALSE AND $cookie['secure'] != FALSE) {
