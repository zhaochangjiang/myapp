                        ...
                        <td class='topMenu'>
                            <div class='topMenu' id='menu1' onmouseover='highlightDIV(1);' onmouseout='clearDIV(1);'
                                ...
                                <table style='padding: 2px; border: 1px solid #D0D0D0;'>
                                    <tr>
                                        <td class='topMenu'><img src='graphix/tab.png' width='16' height='16' alt=''/>
                                        </td>
                    ...
                    <tr>
                        <td class='topMenu'>
                            <div class='topMenu' id='menu6' onmouseover='highlightDIV(6);' onmouseout='clearDIV(6);'
                                ...
                                <table style='padding: 2px; border: 1px solid #D0D0D0;'>
                                    <tr>
                                        <td class='topMenu'><img src='graphix/cog.png' width='16' height='16' alt=''/>
                                        </td>
                        ...
                        <td class='topMenu'>
                            <div class='topMenu' id='menu7' onmouseover='highlightDIV(7);' onmouseout='clearDIV(7);'
                                ...
                                <table style='padding: 2px; border: 1px solid #D0D0D0;'>
                                    <tr>
                                        <td class='topMenu'><img src='graphix/accept.png' width='16' height='16'
                                                                 alt=''/></td>
        ...
        <tr>
            <td valign='top'>
                ...
                <div class="roundedCorner" id='tab1'
                    ...
                    <table
                        style='background-color: #E8E8E8; padding: 1px; border-top: 1px solid #F5F5F5; border-bottom: 1px solid #E0E0E0'>
                        <tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='g_width' value='700' style='width: 30px; text-align: center'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'
                                       onkeyup='doLayout();'/></td>
                            <td>&nbsp;&nbsp; Height &nbsp;</td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' class='color' id='g_title_color' value='#FFFFFF'
                                       ...
                                       onchange='applyColor("g_title_color","g_title_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>&nbsp;&nbsp; Size &nbsp;</td>
                            <td><input type='text' id='g_title_font_size' value='14'
                                       style='width: 20px; text-align: center;' onmouseover='setFocus(this,true);'
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' class='color' id='g_solid_color' value='#AAB757'
                                       style='text-align: center; width: 60px;'
                                       onchange='applyColor("g_solid_color","g_solid_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td width='40'>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' class='color' id='g_gradient_end' value='#018A44'
                                       style='text-align: center; width: 60px;'
                                       onchange='applyColor("g_gradient_end","g_gradient_end_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='g_gradient_alpha' value='50'
                                       style='width: 20px; text-align: center' onmouseover='setFocus(this,true);'
                                       onmouseout='setFocus(this,false);'/></td>
                            <td>%</td>
                        </tr>
                ...
                <div class="roundedCorner" id='tab2'
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Enabled</td>
                            <td>
                                <center><input type='checkbox' id='d_serie1_enabled' checked='checked'
                                               onclick='checkEnabledAxis();'/></center>
                            </td>
                            <td>
                                <center><input type='checkbox' id='d_serie2_enabled' checked='checked'
                                               onclick='checkEnabledAxis();'/></center>
                            </td>
                            <td>
                                <center><input type='checkbox' id='d_serie3_enabled' checked='checked'
                                               onclick='checkEnabledAxis();'/></center>
                            </td>
                            <td>
                    ...
                    <table>
                        <tr>
                            <td width='46'>Name</td>
                            <td width='65'>
                                <center><input type='text' id='d_serie1_name' value='Serie 1'
                                               style='width: 50px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                            <td width='65'>
                                <center><input type='text' id='d_serie2_name' value='Serie 2'
                                               style='width: 50px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                            <td width='65'>
                                <center><input type='text' id='d_serie3_name' value='Serie 3'
                                               style='width: 50px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center><input type='text' id='d_serie1_data<?php echo $i; ?>'
                                                   style='width: 50px; text-align: center'
                                                   onmouseover='setFocus(this,true);'
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Name</td>
                            <td>
                                <center><input type='text' id='d_axis0_name' value='1st axis'
                                               style='width: 76px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                            <td>
                                <center><input type='text' id='d_axis1_name' value='2nd axis'
                                               style='width: 76px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                            <td>
                                <center><input type='text' id='d_axis2_name' value='3rd axis'
                                               style='width: 76px; text-align: center'
                                               onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/>
                                </center>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><select id='d_axis0_format' style='width: 80px;'
                                                onchange='checkEnabledAxis();'><?php listaxisformat(); ?></select>
                                </center>
                            </td>
                            <td>
                ...
                <div class="roundedCorner" id='tab3'
                    ...
                    <table>
                        <tr>
                            ...
                            <td width='35'><input type='text' id='s_x_margin' value='0'
                                                  style='width: 30px; text-align: center'
                                                  onmouseover='setFocus(this,true);'
                                                  onmouseout='setFocus(this,false);'/></td>
                            <td width='50'>&nbsp; Y Margin</td>
                            <td width='68'><input type='text' id='s_y_margin' value='0'
                                                  style='width: 30px; text-align: center'
                                                  onmouseover='setFocus(this,true);'
                                                  onmouseout='setFocus(this,false);'/></td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='s_font_color' class='color' value='#000000'
                                       ...
                                       onchange='applyColor("s_font_color","s_font_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='s_x_label_rotation' value='0'
                                       style='width: 30px; text-align: center' onmouseover='setFocus(this,true);'
                                       onmouseout='setFocus(this,false);'/></td>
                        </tr>
                    </table>
                    <br/>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='s_grid_color' class='color' value='#FFFFFF'
                                       ...
                                       onchange='applyColor("s_grid_color","s_grid_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                            ...
                            <td>&nbsp; Alpha</td>
                            <td>&nbsp; <input type='text' id='s_grid_alpha' value='50'
                                              style='width: 30px; text-align: center' onmouseover='setFocus(this,true);'
                                              onmouseout='setFocus(this,false);'/></td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='s_ticks_color' class='color' value='#000000'
                                       style='text-align: center; width: 60px; text-align: center'
                                       onchange='applyColor("s_ticks_color","s_ticks_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                            ...
                            <td>&nbsp; Alpha</td>
                            <td>&nbsp; <input type='text' id='s_ticks_alpha' value='50'
                                              style='width: 30px; text-align: center' onmouseover='setFocus(this,true);'
                                              onmouseout='setFocus(this,false);'/></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <td>&nbsp; Alpha</td>
                            <td>&nbsp; <input type='text' id='s_subticks_alpha' value='50'
                                              style='width: 30px; text-align: center' onmouseover='setFocus(this,true);'
                                              onmouseout='setFocus(this,false);'/></td>
                            <td>&nbsp;<input type='checkbox' id='s_subticks_enabled' checked='checked'
                                             onclick='toggleSubTicks();'/></td>
                            <td>&nbsp;enabled</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="roundedCorner" id='tab4'
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select id='c_family'
                                        onchange='checkChartSettings();'><?php echo listCharts(); ?></select></td>
                            <td>&nbsp;Break color</td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>&nbsp;<input type='text' id='c_border_size' value='2'
                                             style='width: 20px; text-align: center' onmouseover='setFocus(this,true);'
                                             onmouseout='setFocus(this,false);'/></td>
                            <td>&nbsp;<input type='checkbox' id='c_border_enabled' checked='checked'
                                             onclick='checkPlotBorder();'/></td>
                    ...
                    <table>
                        <tr>
                            <td>&nbsp;<input type='radio' id='c_bar_classic' name='c_bar_design' value='0'
                                             checked='checked'/></td>
                            <td>&nbsp;Classic</td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='c_transparency' value='50'
                                       style='width: 20px; text-align: center' onmouseover='setFocus(this,true);'
                                       onmouseout='setFocus(this,false);'/></td>
                            <td>&nbsp;<input type='checkbox' id='c_forced_transparency' checked='checked'
                                             onclick='checkAreaChart();'/></td>
                            <td>&nbsp;enabled</td>
                ...
                <div class="roundedCorner" id='tab5'
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='l_font_color' class='color' value='#000000'
                                       style='text-align: center; width: 50px;'
                                       onchange='applyColor("l_font_color","l_font_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td width='60'><input type='text' id='t_value' value='0'
                                                  style='width: 30px; text-align: center'
                                                  onmouseover='setFocus(this,true);'
                                                  onmouseout='setFocus(this,false);'/></td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type='text' id='t_color' class='color' value='#000000'
                                       style='text-align: center; width: 50px;'
                                       onchange='applyColor("t_color","t_color_show");'
                                       onmouseover='setFocus(this,true);' onmouseout='setFocus(this,false);'/></td>
                            <td>
                                <div id='t_color_show'
                                     style='margin-left: 4px; width: 10px; height: 10px; border: 1px solid #808080;'></div>
                    ...
                    <table
                        style='background-color: #E8E8E8; padding: 1px; border-top: 1px solid #F5F5F5; border-bottom: 1px solid #E0E0E0'>
                        <tr>
                            <td width='20'><img src='graphix/shape_flip_vertical.png' width='16' height='16' alt=''/>
                            </td>
