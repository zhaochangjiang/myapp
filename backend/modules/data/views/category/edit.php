        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="category_label" placeholder="请填类型名称"
                               value="<?php echo $this->data['data']['category_label']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <?php if ('add' !== $this->params['doType']): ?>
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <div class="input-group">
                            <input type="text" name="sku" disabled="disabled" placeholder="sku"
                                   value="<?php echo $this->data['data']['sku']; ?>" class="form-control">
                        </div>
                    </div>
                </div>
            <?php endif; ?>
