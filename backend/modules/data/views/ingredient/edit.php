            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="ingredient_name" placeholder="请填写食材名" value="<?php echo $this->data['data']['ingredient_name']; ?>" class="form-control">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <?php
                      $uploadUrl = $this->createUrl(array(
                          ...
                          'type' => 'thumbnail'));
                      $uploadFileThumbnailParams = array(
                          'paramName' => 'ingredient_thumbnail',
                          'minFileCount' => 1,
                          'uploadUrl' => $uploadUrl,
                          'maxFileCount' => 1,
                          'renderTemplate' => '@backend/modules/layout/views',
                          'nameSpace' => 'backend\common\blocks',
                          'initialPreview' => $this->getPrivewPicture()
                      );
                      
                      $this->loadBlock('UploadImageFile', $uploadFileThumbnailParams);
                    ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <?php
                      ...
                      $this->loadBlock('UploadImageFile', $uploadFileParams);
                    ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        <input type="text" name="ingredient_foodalias" placeholder="请填写食材别名" value="<?php echo $this->data['data']['ingredient_foodalias']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="">
                        <input type="text" name="ingredient_keyword" placeholder="食材特点" value="<?php echo $this->data['data']['ingredient_keyword']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="">
                        <input type="text" name="ingredient_desc" placeholder="简单描述" value="<?php echo $this->data['data']['ingredient_desc']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <textarea name="ingredient_description" placeholder="请输入 ..." rows="5" class="form-control"><?php echo $this->data['data']['ingredient_description']; ?></textarea>
                </div>
            </div>
        </div>
