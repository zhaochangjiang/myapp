            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="picure_categoryname" placeholder="请填写类型名" value="<?php echo $this->data['data']['picure_categoryname']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="picure_categorykey" placeholder="请填写类型KEY" value="<?php echo $this->data['data']['picure_categorykey']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="picure_savepath" placeholder="请填写savepath" value="<?php echo $this->data['data']['picure_savepath']; ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
