...
// use backend\modules\permit\blocks\PermitSelect;
?>     
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="name" placeholder="请填写权限名" value="<?php echo $this->data['data']['name']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label">上级权限</label>
                <?php echo $this->loadBlock('PermitSelect'); ?>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label"><?php echo 'controller|action'; ?></label>
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" name="module" placeholder="" value="<?php echo $this->data['data']['module']; ?>" size="20" class="form-control">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" name="controller" placeholder="" value="<?php echo $this->data['data']['controller']; ?>" size="20" class="form-control">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" name="action" placeholder="" value="<?php echo $this->data['data']['action']; ?>" size="20" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="csscode" placeholder="" value="<?php echo $this->data['data']['csscode']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="input-group">
                        <input type="text" name="obyid" placeholder="" value="<?php echo $this->data['data']['obyid']; ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
