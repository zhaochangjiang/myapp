...
<div id="uploadfile_<?php echo $this->params['paramName']; ?>">
    ...
    <input id="file-<?php echo $this->params['paramName']; ?>"  data-upload-url="<?php echo $this->params['uploadUrl']; ?>"  name="<?php echo $this->params['paramName']; ?>" class="file" type="file" multiple data-min-file-count="<?php echo $this->params['minFileCount']; ?>" data-max-file-count="<?php echo $this->params['maxFileCount']; ?>">
    <script>
